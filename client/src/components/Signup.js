...
const validate = (values) => {
  ...
  } else if (values.addressOne.length < 2) {
    errors.addressOne = "Must be 2 characters or more";
  }

  if (!values.addressTwo) {
    errors.addressTwo = "Required";
  } else if (values.addressTwo.length < 10) {
    errors.addressTwo = "Must be 10 characters or more";
  }
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        if (res.data) history.push("/sign-in");
      } catch (err) {
      ...
      <div className="row vh-100">
        ...
        <div className="col-md-7 align-self-md-center">
          ...
          >
            ...
            <div className="form-row">
              <div className="form-group col-md-6">
                <label htmlFor="inputAddressOne">Flat/ House No</label>
                <input
                  type="text"
                  className="form-control"
                  id="inputAddressOne"
              ...
              <div className="form-group col-md-6">
                <label htmlFor="inputAddressTwo">Street/Locality</label>
                <input
                  type="text"
                  className="form-control"
                  id="inputAddressTwo"
              ...
              <div className="form-group col-md-6">
                <label htmlFor="inputLandmark">Landmark (if any)</label>
                <input
                  type="text"
                  className="form-control"
                  id="inputLandmark"
